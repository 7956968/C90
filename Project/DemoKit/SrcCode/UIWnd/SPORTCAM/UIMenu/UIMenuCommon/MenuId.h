...
enum _MENU_ID {
	...
	// Movie Page
	//IDM_MOVIE_SIZE,//lyb -20200328
	//IDM_MOVIE_CYCLIC_REC,//lyb -20200328
	IDM_MOVIE_WDR,
	IDM_MOVIE_HDR,
	IDM_MOVIE_EV,
	IDM_MOVIE_MOTION_DET,
	//IDM_MOVIE_AUDIO, //lyb -20200328
...
//#MT#lyb -20200328 -begin
    ...
    IDM_DEFAULT,
    IDM_VERSION,
    IDM_ALARM,//AV_LCA_FUNC
//#MT#lyb -20200328 -end
#if(_ANFA_ADAS_MENU_)
	IDM_ANFA_ADAS,
#endif
IDM_SETLCDBRIGHTLVL,
IDM_MOVIE_BACKADJUST,
...
enum _MENU_IDS {
	...
	// Movie Page
	//IDS_MOVIE_SIZE          = STRID_RESOLUTION,//lyb -20200328
	IDS_MOVIE_EV            = STRID_EXPOSURE,
	//IDS_MOVIE_CYCLIC_REC    = STRID_CYCLIC_REC,//lyb -20200328
	IDS_MOVIE_HDR           = STRID_HDR,
	IDS_MOVIE_WDR           = STRID_WDR,
	IDS_MOVIE_MOTION_DET    = STRID_MOTION_DET,
	//IDS_MOVIE_AUDIO         = STRID_RECORD_AUDIO,//lyb -20200328
	...
	IDS_MOVIE_SIZE_DUAL_2560x1440P30_2560x1440P30  = STRID_DUAL_2560x1440P30_2560x1440P30, //QHD QHD
	...
	IDS_MOVIE_SIZE_DUAL_1920x1080P60_1920x1080P60  = STRID_DUAL_1080P60_1080P60, //FHDp60 FHDp60
	...
	IDS_MOVIE_CYCLICREC_OFF    = STRID_OFF,
	IDS_MOVIE_CYCLICREC_1MIN   = STRID_1MIN,
	IDS_MOVIE_CYCLICREC_3MIN   = STRID_3MIN,
	IDS_MOVIE_CYCLICREC_5MIN   = STRID_5MIN,
	IDS_MOVIE_CYCLICREC_10MIN  = STRID_10MIN,
	...
	//IDS_VOLUME              = STRID_VOLUME,    //lyb -20200328
	...
	// Setup Page
	//IDS_DATE_TIME           = STRID_DATE_TIME,  //lyb -20200328
	...
	//IDS_FORMAT              = STRID_FORMAT,    //lyb -20200328
	//IDS_DEFAULT             = STRID_DEFAULT_SETTING,     //lyb -20200328
	IDS_OPENING_LOGO        = STRID_LOGO_DISPLAY,
	//IDS_VERSION             = STRID_VERSION,    //lyb -20200328
	//IDS_WIFI                = STRID_WIFI,  //lyb -20200328
	...
	IDS_MOVIE_BACKADJUST = STRID_MOVIE_BACKADJUST, //STRID_MOVIE_BACKADJUST,
	IDS_MOVIE_BACKADJUST_OFF = STRID_OFF,
	IDS_MOVIE_BACKADJUST_ON = STRID_ON,
	// Language Options
...
//#MT#lyb -20200328 -begin
    IDS_MOVIE_SIZE          = STRID_SETUP_MOVIESIZE,
    IDS_MOVIE_CYCLIC_REC    = STRID_SETUP_CYCLICREC,


    IDS_APP                 = STRID_SETUP_APP,
    IDS_WIFIINFO            = STRID_SETUP_WIFIINFO,
    IDS_WIFI                = STRID_SETUP_WIFI,
    IDS_DATE_TIME           = STRID_SETUP_DATE,
    IDS_VOLUME              = STRID_SETUP_VOLUME,
    IDS_SCREENLIGHT         = STRID_SETUP_SCREENLIGHT,
    IDS_URGSENSE            = STRID_SETUP_URGSENSE,
    IDS_PARK                = STRID_SETUP_PARK,
    IDS_MOVIE_AUDIO         = STRID_SETUP_AUDIO,
    IDS_FORMAT              = STRID_SETUP_FORMAT,
    IDS_DEFAULT             = STRID_SETUP_RESET,
    IDS_VERSION             = STRID_SETUP_ABOUT,
    IDS_ALARM               = STRID_SETUP_ALARM,//AV_LCA_FUNC
	#if(_ANFA_ADAS_MENU_)
	IDS_ANFA_ADAS			= STRID_SETUP_ANFA_ADAS,
	#endif
    //Option
    IDS_VOLUME_OFF          = STRID_OFF,
    IDS_VOLUME_LOW          = STRID_LOW,
    IDS_VOLUME_MED          = STRID_MED,
    IDS_VOLUME_HIGH         = STRID_HIGH,
    ...
    IDS_MOVIE_PARK_OFF      = STRID_OFF,
    IDS_MOVIE_PARK_LOW      = STRID_LOW,
    IDS_MOVIE_PARK_MED      = STRID_MED,
    IDS_MOVIE_PARK_HIGH     = STRID_HIGH,
    
    IDS_ALARM_LCA_OFF       = STRID_OFF,
    IDS_ALARM_LCA_ON        = STRID_ON,

	#if(_ANFA_ADAS_MENU_)
    IDS_ANFA_ADAS_OFF       = STRID_OFF,
    IDS_ANFA_ADAS_ON        = STRID_ON,
	#endif

    IDS_SCREENLIGHT_MANUAL  = STRID_OFF,
    IDS_SCREENLIGHT_AUTO    = STRID_ON,
...
enum _MENU_IDI {
	...
	// Movie Page
	//IDI_MOVIE_SIZE          = ICON_RESOLUTION_M,    //lyb -20200328
	IDI_MOVIE_EV            = ICON_EV_M,
	//IDI_MOVIE_CYCLIC_REC    = ICON_CYCLIC_REC_M,    //lyb -20200328
	IDI_MOVIE_HDR           = ICON_HDR_M,
	IDI_MOVIE_WDR           = ICON_MENU_WDR_M,
	IDI_MOVIE_MOTION_DET    = ICON_MOTION_DET_ON_M,
	//IDI_MOVIE_AUDIO         = ICON_SOUND_REC_ON_M,      //lyb -20200328
	...
	// Setup Page
	//IDI_DATE_TIME           = ICON_DATETIME_SETUP_M,    //lyb -20200328
	...
	//IDI_FORMAT              = ICON_FORMAT_M,    //lyb -20200328
	//IDI_DEFAULT             = ICON_DEFAULT_M,    //lyb -20200328
	//IDI_WIFI                = ICON_WIFI_ON_M,    //lyb -20200328
	//IDI_VERSION             = ICON_VERSION_M,    //lyb -20200328
	...
	IDI_LANG_YI             = ICON_OK,
	IDI_LANG_PL             = ICON_OK,
	IDI_MOVIE_BACKADJUST 	= ICON_SETUP_ABOUT,

//#MT#lyb -20200328 -begin
    IDI_MOVIE_SIZE          = ICON_SETUP_MOVIESIZE,
    IDI_MOVIE_CYCLIC_REC    = ICON_SETUP_CYCLIC,

    IDI_APP                 = ICON_SETUP_APP,
    IDI_WIFIINFO            = ICON_SETUP_WIFIINFO,
    IDI_WIFI                = ICON_SETUP_WIFI,
    IDI_DATE_TIME           = ICON_SETUP_DATE,
    IDI_VOLUME              = ICON_SETUP_VOLUME,
    IDI_SCREENLIGHT         = ICON_SETUP_SCREENLIGHT,
    IDI_URGSENSE            = ICON_SETUP_URGSENSE,
    IDI_PARK                = ICON_SETUP_PARK,
    IDI_MOVIE_AUDIO         = ICON_SETUP_AUDIO,
    IDI_FORMAT              = ICON_SETUP_FORMAT,
    IDI_DEFAULT             = ICON_SETUP_RESET,
    IDI_VERSION             = ICON_SETUP_ABOUT,
    IDI_ALARM              	= ICON_SETUP_ALARM,//AV_LCA_FUNC
//#MT#lyb -20200328 -end
#if(_ANFA_ADAS_MENU_)
	IDI_ANFA_ADAS			= ICON_SETUP_ANFA_ADAS,
#endif
...
enum _MENU_IDF {
	...
	// Movie Page
	//IDF_MOVIE_SIZE                       = FL_MOVIE_SIZE_MENU, //only keep in menu     //lyb -20200328
	//IDF_MOVIE_CYCLIC_REC                 = FL_MOVIE_CYCLIC_REC,    //lyb -20200328
	IDF_MOVIE_HDR                        = FL_MOVIE_HDR_MENU,
	IDF_MOVIE_WDR                        = FL_MOVIE_WDR_MENU,
	IDF_MOVIE_MOTION_DET                 = FL_MOVIE_MOTION_DET,
	//IDF_MOVIE_AUDIO                      = FL_MOVIE_AUDIO,  //lyb -20200328
	...
	// Playback page
	//IDF_VOLUME                           = FL_MovieAudioPlayIndex,  //lyb -20200328
	// Setup Page
...
//#MT#lyb -20200328 -begin
    ...
    IDF_MOVIE_CYCLIC_REC            = FL_MOVIE_CYCLIC_REC_MENU,
    ...
    IDF_ALARM                       = FL_ALARM_LCA,//AV_LCA_FUNC
//#MT#lyb -20200328 -end
	#if(_ANFA_ADAS_MENU_)
	IDF_ANFA_ADAS					= FL_ANFA_ADAS,
	#endif
	IDF_MOVIE_BACKADJUST  = FL_MOVIE_BACKADJUST,
};
